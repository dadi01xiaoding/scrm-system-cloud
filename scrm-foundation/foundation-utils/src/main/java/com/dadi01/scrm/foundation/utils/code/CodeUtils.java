package com.dadi01.scrm.foundation.utils.code;
...
public class CodeUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		String encryptData = DES.encryptHex(source, key);
		System.out.println("加密后: " + encryptData);
		String decryptData = DES.decryptHex(encryptData, key);
		System.out.println("解密后: " + decryptData);

		long l = CodeUtils.strToLong("1.3.4.35");
		System.out.println(l);
		String str = CodeUtils.longToStr(l);
